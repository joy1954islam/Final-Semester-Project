...
def save_ministry_form(request, form, template_name):
    ...
    if request.method == 'POST':
        if form.is_valid():
            ...
            ministrys = Ministry.objects.all()
            data['html_ministry_list'] = render_to_string('SuperAdmin/Ministry/partial_ministry_list.html',
                                                          {'ministrys': ministrys})
        else:
...
def ministry_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        data['html_form'] = render_to_string('SuperAdmin/Ministry/partial_ministry_delete.html', context,
                                             request=request)
    return JsonResponse(data)
...
def employee_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        data['html_form'] = render_to_string('SuperAdmin/GovtEmployee/partial_employee_delete.html', context,
                                             request=request)
    return JsonResponse(data)
